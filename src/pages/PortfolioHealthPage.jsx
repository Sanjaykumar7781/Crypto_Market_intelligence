      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <p className="text-gray-900 font-semibold mt-1">0-100 scale</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="p-4 rounded-xl border border-gray-200 bg-gray-50 backdrop-blur-md"
          >
            <p className="text-gray-500 text-sm">⚠️ Risk Assessment</p>
            <p className="text-gray-900 font-semibold mt-1">Low to High</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="p-4 rounded-xl border border-gray-200 bg-gray-50 backdrop-blur-md"
          >
            <p className="text-gray-500 text-sm">🎯 AI Recommendations</p>
            <p className="text-gray-900 font-semibold mt-1">Personalized advice</p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="mt-12 p-4 rounded-lg border border-gray-200 bg-gray-50 backdrop-blur-md text-center text-gray-500 text-sm"
        >
