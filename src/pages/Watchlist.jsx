      ...
      >
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-black text-gray-900 bg-gradient-to-r from-gray-900 via-gray-600 to-gray-400 bg-clip-text text-transparent">Watchlist Monitor</h1>
            <p className="text-xs text-gray-500 mt-1">Real-time alerts and stats of your saved digital assets</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="metric-card-premium group min-w-36 p-4 py-3" style={{ '--glow-start': 'rgba(6,182,212,0.2)', '--glow-end': 'rgba(139,92,246,0.15)' }}>
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <span className="text-[10px] font-black uppercase tracking-wider text-gray-500">Tracked Value</span>
              </div>
              <p className="text-lg font-black text-gray-900">{currency(value, false, currencyCode)}</p>
            </div>
            <div className="metric-card-premium group min-w-36 p-4 py-3" style={{ '--glow-start': change >= 0 ? 'rgba(47,244,166,0.2)' : 'rgba(255,77,141,0.2)', '--glow-end': 'rgba(139,92,246,0.15)' }}>
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <span className="text-[10px] font-black uppercase tracking-wider text-gray-500">Avg 24h P/L</span>
              </div>
        ...
        <div className="mt-2">
          {items.length ? (
            ...
            <div className="glass-premium rounded-2xl p-10 text-center border border-gray-200 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center gap-3">
                ...
                <h2 className="text-lg font-black text-gray-900">No assets saved yet</h2>
                <p className="text-xs text-gray-500 max-w-sm leading-relaxed">Use the star icon in market tables or coin pages to build your custom watchlist tracker.</p>
              </div>
            </div>
          )}
        </div>
