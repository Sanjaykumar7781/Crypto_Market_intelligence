      ...
      <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[.9fr_1.1fr]">
        <section className="glass rounded-lg p-6">
          ...
          <div className="mt-6 space-y-3">
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">✓ Email and password authentication</div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">✓ Persistent watchlist sync</div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">✓ Portfolio tracking</div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">✓ AI-powered market insights</div>
          </div>
        </section>
        ...
        <form className="glass rounded-lg p-6" onSubmit={handleSubmit}>
          ...
          {!isLoginMode && (
            <>
              <label className="mb-2 block text-sm font-bold text-gray-300">Full Name</label>
              <input
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="mb-2 block text-sm font-bold text-gray-300">Age</label>
                  <input
                    className="input w-full"
                    type="number"
                    min="0"
          ...
          <label className="mb-2 block text-sm font-bold text-gray-300 {!isLoginMode && 'mt-4'}">Email</label>
          ...
          <label className="mb-2 mt-4 block text-sm font-bold text-gray-300">Password</label>
          <div className="relative">
            <LockKeyhole className="absolute left-3 top-3.5 text-gray-500" size={18} />
            <input
          ...
          {!isLoginMode && password && (
            <p className={`text-xs mt-2 ${strengthColor[passwordStrength] || 'text-gray-400'}`}>
